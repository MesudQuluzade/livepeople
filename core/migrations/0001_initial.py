# Generated by Django 5.2.17 on 2026-09-09 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Bakı', max_length=80)),
                ('bio', models.TextField(blank=True, default='Yeni insanlarla tanışmağı sevirəm.')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatars/')),
                ('coins', models.PositiveIntegerField(default=1250)),
                ('is_online', models.BooleanField(default=False)),
                ('last_seen', models.DateTimeField(blank=True, null=True)),
                ('phone_model', models.CharField(blank=True, max_length=120)),
                ('soft_banned_until', models.DateTimeField(blank=True, null=True)),
